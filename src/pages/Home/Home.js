            ...
            <div className="banner-area" id="home">
                    <div className="banner-content">
                        ...
                        <div className="tag"><h1 className="text-uppercase">A center of <br></br>Rx visualization </h1></div>                                           
                            <div className="tag-line"><p><b>Medication Visualizer</b> is an intuitive web-based visualization application, which aims to provide healthcare professionals with a visual representation of all available medications to make it easier to sort through the appropriate products with more meaningful groupings.</p></div>
                    </div>
            </div>
                ...
                <div className="feature-detail">
                    <div className="item">
                        ...
                        <div>
                            ...
                            <h6 className="header">Search medications with dropdown and display results in a table</h6>
                    ...
                    <div className="item">
                        ...
                        <div>
                            ...
                            <h6 className="header">Important aspect of medications visualized as charts</h6>
                    ...
                    <div className="item">
                        ...
                        <div>
                            ...
                            <p className="detail">Bar graph of the number of ingredients that make up a medication</p>
